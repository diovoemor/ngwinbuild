...
# Based in part on the GNU makefile by G. Vanem <gvanem yahoo com> 2013       #
###############################################################################
NAME     = nghttp2
...
linker:
  ...
  @echo.    
  $(LL) $(LFLAGS) $(OBJDIR)\r_$(NAME).res /out:$(DLLR) $(OBJDIR)\r_*.obj
  $(LL) $(LFLAGS) $(OBJDIR)\d_$(NAME).res /out:$(DLLD) $(OBJDIR)\d_*.obj
